...
##Project Submission
1. Please create your Project 2A and 2B github repos / and push to heroku
2. Submit the links at the **[Project 2 submission page](https://docs.google.com/a/generalassemb.ly/forms/d/e/1FAIpQLScmeIIOFOADGlQY9na650d0jrvg9lAjGhry-pV-fZqtRuSmbw/viewform)** 
3. The early submission of links is to enable the instructional staff to monitor the progress of the projects. 
4. The deadline for this project is on Friday 5th August 2016, 8am
...
### Project 2A: Redmart E-shop (Compulsory)
Develop a Redmart clone with the below minimum technical requirements.

### Project 2B: Freestyle App (Optional Bonus)
