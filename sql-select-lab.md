...
- The starter code will be sent via the slack channel.
...
Again, be sure to grab the .sql file from the starter code and run it in your PostgreSQL terminal using the commands above.
