...
- add `// JavaScript to be added` to your `scripts.js` file and link to your JavaScript file in your html file
...
- open the project and add to the code - after the user enters their email, the button should change text to say, "Thanks for your email!"
