...
var wdi = new Classroom("2 Singapore", 25);
```
...
classroom.campus = "Singapore";
=> "Singapore"

classroom
=> Object {name: "WDI 2", campus: "Singapore"}
```
...
```
var classroom = {name: "WDI 2", campus: "Singapore", start: "15/2/2016"};
delete classroom.start;
classroom
=> {name: "WDI 2", campus: "Singapore"}
```
...
classroom.classInfo()
=> This is WDI 2 and it starts on 15/2/2016
```
